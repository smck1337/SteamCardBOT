...
client.on("friendMessage", (SENDER, MSG) => {
    ...
    if (MSG.toUpperCase().indexOf("!LEVEL") >= 0) {
        ...
        if (botSets) {
            if (CONFIG.CARDS.PEOPLETHATCANSELL.indexOf(SENDER.getSteamID64().toString()) >= 0 || CONFIG.CARDS.PEOPLETHATCANSELL.indexOf(parseInt(SENDER.getSteamID64())) >= 0) {
                ...
                client.chatMessage(SENDER, "You are not able to sell sets.");
            }
        } else {
            client.chatMessage(SENDER, "Please try again later.");
        }
        ...
        client.chatMessage(SENDER, "This bot was made by www.steamcommunity.com/id/timandyouknow");
